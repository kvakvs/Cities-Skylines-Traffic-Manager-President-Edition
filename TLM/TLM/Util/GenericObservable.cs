namespace TrafficManager.Util {
    ...
    public abstract class GenericObservable<T> : IObservable<T> {
        ...
        /// <summary>Lock object. Acquire this before accessing the HashSets.</summary>
        protected object ObserverLock = new object();

        /// <summary>Registers an observer.</summary>
        /// <param name="observer">Observer impl.</param>
        ...
        /// <summary>Notifies all observers that the observable object' state has changed.</summary>
