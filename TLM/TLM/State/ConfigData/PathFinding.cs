namespace TrafficManager.State.ConfigData {
    public class PathFinding {
        /// <summary>penalty for busses not driving on bus lanes.</summary>
        public float PublicTransportLanePenalty = 10f;

        /// <summary>reward for public transport staying on transport lane.</summary>
        public float PublicTransportLaneReward = 0.1f;

        /// <summary>maximum penalty for heavy vehicles driving on an inner lane.</summary>
        ...
        /// <summary>artifical lane distance for u-turns.</summary>
        public int UturnLaneDistance = 2;

        /// <summary>Maximum walking distance.</summary>
        public float MaxWalkingDistance = 2500f;

        /// <summary>Minimum penalty for entering public transport vehicles.</summary>
        public float PublicTransportTransitionMinPenalty = 0f;

        /// <summary>Maximum penalty for entering public transport vehicles.</summary>
