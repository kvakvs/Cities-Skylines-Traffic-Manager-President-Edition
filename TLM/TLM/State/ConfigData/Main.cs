namespace TrafficManager.State.ConfigData {
    ...
    public class Main {
        ...
        /// <summary>Overlay transparency.</summary>
        public byte OverlayTransparency = 40;

        /// <summary>Extended mod compatibility check.</summary>
        public bool ShowCompatibilityCheckErrorMessage = false;

        /// <summary>Shows warning dialog if any incompatible mods detected.</summary>
        public bool ScanForKnownIncompatibleModsAtStartup = true;

        /// <summary>Skip disabled mods while running incompatible mod detector.</summary>
        public bool IgnoreDisabledMods = true;

        /// <summary>Prefer Miles per hour instead of Kmph (affects speed limits display.
        ///     but internally Kmph are still used).</summary>
