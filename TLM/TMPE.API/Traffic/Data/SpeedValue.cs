namespace TrafficManager.API.Traffic.Data {
    ...
    public struct SpeedValue {
        ...
        public VelocityValue ToVelocity() {
            return new VelocityValue(GameUnits * ApiConstants.SPEED_TO_VELOCITY);
        }
    ...
    /// <summary>
    /// Represents game velocity which is speed multiplied by 8f and having a direction stored
    /// somewhere else.
    /// </summary>
    public struct VelocityValue {
        public const float SPEED_TO_VELOCITY = 8f;
        public const float KMPH_TO_VELOCITY = SPEED_TO_VELOCITY / ApiConstants.SPEED_TO_KMPH;

        public VelocityValue(float velocity) {
            Velocity = velocity;
        }
