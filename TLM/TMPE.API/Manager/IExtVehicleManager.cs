namespace TrafficManager.API.Manager {
    ...
    public interface IExtVehicleManager {
        /// <summary>Gets extended vehicle data array.</summary>
        ExtVehicle[] ExtVehicles { get; }

        /// <summary>Handles a released vehicle.</summary>
        ...
        /// <param name="vehicleData">vehicle data accompanying the released vehicle.</param>
        void OnRelease(ref ExtVehicle extVehicle, ref Vehicle vehicleData);

        /// <summary>Handles a created vehicle.</summary>
        /// <param name="vehicleId">vehicle id.</param>
        /// <param name="vehicleData">vehicle data.</param>
        ...
        /// <summary>Handles a created vehicle.</summary>
        /// <param name="extVehicle">vehicle.</param>
        /// <param name="vehicleData">vehicle data accompanying the vehicle.</param>
        void OnCreate(ref ExtVehicle extVehicle, ref Vehicle vehicleData);

        /// <summary>Handles a spawned vehicle.</summary>
        /// <param name="vehicleId">vehicle id.</param>
        /// <param name="vehicleData">vehicle data accompanying the vehicle.</param>
        ...
        /// <summary>Handles a despawned vehicle.</summary>
        /// <param name="vehicleId">vehicle id.</param>
        /// <param name="vehicleData">vehicle data accompanying the vehicle.</param>
        ...
        /// <summary>Handles a vehicle when path-finding starts.</summary>
        /// <param name="vehicleId">vehicle id.</param>
        /// <param name="vehicleData">vehicle data accompanying the vehicle.</param>
        ...
        /// <summary>Retrieves the driver citizen instance id for the given vehicle.</summary>
        /// <param name="vehicleId">vehicle id.</param>
        /// <param name="data">vehicle data.</param>
        /// <returns>Driver instance id.</returns>
        ushort GetDriverInstanceId(ushort vehicleId, ref Vehicle data);

        /// <summary>Updates the vehicle's current path position.</summary>
        /// <param name="vehicleId">vehicle id.</param>
        /// <param name="vehicleData">vehicle data.</param>
        ...
        /// </summary>
        /// <param name="extVehicle">vehicle.</param>
        /// <returns>Whether the junction transit state is considered new.</returns>
        bool IsJunctionTransitStateNew(ref ExtVehicle extVehicle);

        /// <summary>
        /// Triggers the randomization mechanism that might select a new random value for
        /// time-varying vehicle behavior (e.g. speed).
        /// </summary>
