namespace TrafficManager.API.Manager {
    ...
    public interface IExtSegmentEndManager {
        /// <summary>Extended segment end data.</summary>
        ExtSegmentEnd[] ExtSegmentEnds { get; }

        /// <summary>Resets both segment ends of the given segment.</summary>
        /// <param name="segmentId">segment id.</param>
        void Reset(ushort segmentId);

        /// <summary>Determines the index of the segment end.</summary>
        /// <param name="segmentId">segment id.</param>
        ...
        /// <summary>Counts the number of registered vehicles for the given segment end.</summary>
        ...
        /// <summary>Performs recalcution of the segment ends for the given segment id.</summary>
        /// <param name="segmentId">segment id.</param>
        ...
        /// <summary>Determines whether the segment end is connected to highways only.</summary>
        /// <param name="segmentId">segment id.</param>
        /// <param name="startNode">Whether is at starting node.</param>
        /// <returns>Whether the segment end is connected to highways only.</returns>
