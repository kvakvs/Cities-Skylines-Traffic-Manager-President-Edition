namespace TrafficManager.API.Manager {
    ...
    public interface IAdvancedParkingManager : IFeatureManager {
        ...
        /// <returns>Whether a custom color should be displayed.</returns>
        ...
        /// <returns>Whether entering the car succeeded.</returns>
        ...
        /// <returns>Indication of how (external) game logic should treat this situation:
        ...
        ///    <code>Ignore</code>: Default citizen behavior must be skipped.</returns>
        ...
        /// <returns>Approach state indication:
        ...
        /// <returns>Whether the citizen arrived at the target.</returns>
        ...
        /// <param name="allowTourists">If true, method fails if given citizen is a tourist.</param>
        ...
        /// <param name="calculateEndPos">if false, a parking space path position could be calculated.</param>
        /// <returns>Whether a parking space could be found.</returns>
        bool FindParkingSpaceForCitizen(Vector3 endPos,
                                        ...
                                        bool goingHome,
                                        ushort vehicleId,
                                        bool allowTourists, // TODO remove this parameter
                                        out Vector3 parkPos,
                                        ref PathUnit.Position endPathPos,
                                        out bool calculateEndPos); // TODO negate & rename parameter
        ...
        /// <returns>Whether the parked vehicle was relocated.</returns>
        ...
        /// <returns>Whether a passenger car could be spawned.</returns>
        ...
        /// <returns>Whether a parking space could be found.</returns>
        // TODO: Refactor return value to Result<T> or Maybe
